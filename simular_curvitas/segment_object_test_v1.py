...
def simulate_stack_microchip(decam_img,gainA,gainB,Exposure,readout_noise,N_imgs):
    ...
    for i in range(N_imgs):
        count_expo+=2.5
        output_filename = "image_sim_"+str(count_expo)+".fits"
...
img_str="/home/santiep/Documents/Doctorado/UBA_2nd_year/Visita_juan/Trap_simulation/one_ext_only/data_ext8.fits"
